...
public class TestHashTable {
	...
	public static void main(String[] args) {
      ...
      //Test insert
        ...
        Random r = new Random();
        int numKeys = 10000, val, runs = 1, duplicates;  //Variables to store # keys, # runs, # duplicate inputs
        // CHANGE: only one run -- what typa supercomputer do y'all think I have???
        ...
        for(loadFactor = 0.1; loadFactor <= 0.9; loadFactor += 0.1){    //Loop through load factors from 0.1 to 0.9
        	// CHANGE: need to reset probeCount for this to work properly
        	probeCount = 0;
        	System.out.println("Linear probing using load factor " + loadFactor);
      ...
      //Simulations to measure the average number of probes for successful search for each lambda (0.1~ 0.9)
        ...
        int numKeysQ = 10000, valQ, runsQ = 1, duplicatesQ;  //Variables to store # keys, # runs, # duplicate inputs
        ...
        for(loadFactorQ = 0.1; loadFactorQ <= 0.9; loadFactorQ += 0.1){    //Loop through load factors from 0.1 to 0.9
        	probeCountQ = 0;
        	System.out.println("Quadratic probing using load factor " + loadFactorQ);
		...
		HashTableLin HTestb = new HashTableLin(numKeys, loadFactor);
	        ...
	        probeunsucces=(double)total/HTestb.getTableSize();
